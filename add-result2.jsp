...
<label for="default" class="col-sm-2 control-label">Class</label>
 ...
 <% 
            											try
        												{
                											...
                											rs.next();
        												%>
 <input type="text" name="class" class="form-control clid" id="classid"  readonly value="<%= rs.getString("ClassName") + " (" + rs.getString("Section") +")"%>">
													...
													<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                    <select name="studentid" class="form-control stid" id="studentid" required="required" onchange="updateHiddenField();">
                                                    <option value="">Select Student Name</option>
                                                     <%
                											query = "SELECT StudentId,StudentName from tblstudents where ClassId=?";
                											pstmt = conn.prepareStatement(query);
                											pstmt.setString(1,ClassId);
                											rs = pstmt.executeQuery();
        												...
        												%>
        												<option value="<%=rs.getString("StudentId")%>"><%=rs.getString("StudentName")%></option>
        												<% }
       													 %></select>
       													  <input type="hidden" name="classValue" id="classValue" value="">
															<script>
															    function updateHiddenField() {
															        var classDropdown = document.getElementById("studentid");
															        var hiddenField = document.getElementById("classValue");
															        hiddenField.value = classDropdown.value;															        
															        var url = "add-result3.jsp?studentid=" + classDropdown.value + "&classid=" + <%=ClassId%>;
