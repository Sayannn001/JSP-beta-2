...
<html lang="en">
    <head>
        ...
        <title>TMSL | Manage Departments</title>
                                        ...
                                        <div class="panel">
											...
											<div class="alert alert-success left-icon-alert" role="alert">
 											...
 											<%
												...
												if(session.getAttribute("updateno")!=null && session.getAttribute("error")!=null)
						                        {
						                        	...
						                        	<div class="alert alert-danger left-icon-alert" role="alert">
														<strong>Record delete failed!</strong> SQL Error.
													</div>
						                        	<%
						                        }
...
<%try 
		{
			...
			int count=0;
			rs = stmt.executeQuery("SELECT * FROM tbldept;");
			while(rs.next())
			{
				count++;
%>	
													<td><%=count%></td>
 													...
 													<td><%=rs.getInt("DeptCode")%></td>
                                                    <td><%=rs.getString("Short")%></td>
                                                    <td><%=rs.getString("CreationDate")%></td>
<td>
	<a href="edit-department.jsp?Id=<%=rs.getInt("Id")%>"><i class="fa fa-edit" title="Edit Record"></i></a>
	<a href="delete-department.jsp?Id=<%=rs.getInt("Id") %>" onclick="return confirm('Are you sure you want to permanently delete this record?.');"><i class="fa fa-trash color-danger" title="Delete Record"></i></a>
</td>
</tr>
<% } %>
