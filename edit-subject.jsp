...
<%
	if (session.getAttribute("alogin") != null) 
	{
		try
		{
			...
			ResultSet rs = null;
			String query = "SELECT * from tblsubjects WHERE id=?";
...
<html lang="en">
    <head>
        ...
        <title>TMSL | Update Subject</title>
                                        ...
                                        <div class="panel">
                                            ...
                                            <%if(session.getAttribute("updateno")!=null && session.getAttribute("duplicate")!=null)
                                    ...
                                    else if(session.getAttribute("error")!=null && session.getAttribute("updateno")!=null)
						                        {
													...
													<%} %>
                                                <form class="form-horizontal" method="post" action="update-subject.jsp">
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Subject Name</label>
                                                        <div class="col-sm-10">
 <input type="text" name="subjectname" class="form-control" id="default" value="<%=rs.getString("SubjectName") %>" required="required">
                                                        </div>
                                                    </div>
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Subject Code</label>
                                                        <div class="col-sm-10">
 <input type="text" name="subjectcode" class="form-control" id="default" placeholder="Subject Code" value="<%=rs.getString("SubjectCode")%>" required="required">
                                                        </div>
                                                    </div>
                                                    
<input type="hidden" name="suid" id="suid" value="<%=request.getParameter("id") %>">	
